...
TEST_F(PowerHintSessionMockedTest, updateSessionJankState) {
    ...
    ASSERT_EQ(SessionJankyLevel::LIGHT,
              mHintSession->updateSessionJankState(SessionJankyLevel::SEVERE, 8, 5.0, true, false));
    ASSERT_EQ(SessionJankyLevel::LIGHT, mHintSession->updateSessionJankState(
                                                SessionJankyLevel::MODERATE, 8, 5.0, true, false));
    ASSERT_EQ(SessionJankyLevel::LIGHT,
              mHintSession->updateSessionJankState(SessionJankyLevel::LIGHT, 8, 5.0, true, false));
    // Light number of jank frames, and high workload duration variance.
    ASSERT_EQ(
            SessionJankyLevel::MODERATE,
            mHintSession->updateSessionJankState(SessionJankyLevel::SEVERE, 1, 5.0, false, false));
    ASSERT_EQ(SessionJankyLevel::MODERATE,
              mHintSession->updateSessionJankState(SessionJankyLevel::MODERATE, 1, 5.0, false,
                                                   false));
    ASSERT_EQ(SessionJankyLevel::LIGHT,
              mHintSession->updateSessionJankState(SessionJankyLevel::LIGHT, 1, 5.0, false, false));
    // Light number of jank frames, and low workload duration variance.
    ASSERT_EQ(SessionJankyLevel::LIGHT, mHintSession->updateSessionJankState(
                                                SessionJankyLevel::SEVERE, 1, 1.0, false, false));
    ASSERT_EQ(SessionJankyLevel::LIGHT, mHintSession->updateSessionJankState(
                                                SessionJankyLevel::MODERATE, 1, 1.0, false, false));
    ASSERT_EQ(SessionJankyLevel::LIGHT,
              mHintSession->updateSessionJankState(SessionJankyLevel::LIGHT, 1, 1.0, false, false));
    // Moderate number of jank frames
    ASSERT_EQ(
            SessionJankyLevel::MODERATE,
            mHintSession->updateSessionJankState(SessionJankyLevel::SEVERE, 4, 5.0, false, false));
    ASSERT_EQ(SessionJankyLevel::MODERATE,
              mHintSession->updateSessionJankState(SessionJankyLevel::MODERATE, 4, 5.0, false,
                                                   false));
    ASSERT_EQ(SessionJankyLevel::MODERATE,
              mHintSession->updateSessionJankState(SessionJankyLevel::LIGHT, 4, 5.0, false, false));
    // Significant number of jank frames
    ASSERT_EQ(SessionJankyLevel::SEVERE, mHintSession->updateSessionJankState(
                                                 SessionJankyLevel::SEVERE, 9, 5.0, false, false));
    ASSERT_EQ(SessionJankyLevel::SEVERE,
              mHintSession->updateSessionJankState(SessionJankyLevel::MODERATE, 9, 5.0, false,
                                                   false));
    ASSERT_EQ(SessionJankyLevel::SEVERE,
              mHintSession->updateSessionJankState(SessionJankyLevel::LIGHT, 9, 5.0, false, false));
    // Force to severe
    ASSERT_EQ(SessionJankyLevel::SEVERE,
